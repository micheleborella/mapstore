...
GeoExt.Lang.add("de", {
	...
	"gxp.plugins.SearchServizioApertura.prototype":{
		vieLang: "de",
		viaText: "Straße",
		viaEmpty: "Straße einfügen",
		viaToolTip: "z.B. für Romstrasse 'Rom' eingeben",
		ricApSerTxt: "Suche der Öffnungszeiten der Dienste",
		selTuttoTxt: "Alles markieren",
		desTuttoTxt: "Alles entmarkieren",
		filTipoTxt: "Nach Typologie filtern:",
		amminTxt: "Verwaltung",
		comuTxt: "Gemeinde und Bezirkgemeinschaft",
		provTxt: "Land und Region",
		statTxt: "Staat",
		acqRifTxt: "Wasser, Müll, Elektrizität",
		prevTxt: "Sozialvorsorge und -Hilfe",
		traspTxt: "Transport und Mobilität",
		turiTxt: "Tourismus und Wirtschaft",
		altroTxt: "Sonstiges",
		sicuTxt: "Sicherheit",
		forzTxt: "Ordnungskräfte",
		vigiTxt: "Feuerwehr",
		eserTxt: "Heer",
		protTxt: "Zivilschutz und Bergrettung",
		sanTxt: "Gesundheit",
		ospTxt: "Krankenhaus, Kliniken, Ambulatorien",
		prontTxt: "Erste Hilfe",
		farmTxt: "Apotheken",
		socTxt: "Sozialwesen",
		anzTxt: "Senioren",
		donnTxt: "Frauen und Gleichberechtigung",
		famTxt: "Familie und Minderjährige",
		giovTxt: "Jugendliche",
		disTxt: "Behinderung und psychische Probleme",
		dipTxt: "Abhängigkeiten",
		sviluTxt: "Gemeinschaftentwicklung und soziale Eingliederung",
		patrTxt: "Patronate",
		clutTxt: "Kultur",
		biblTxt: "Bibliotheken",
		saleTxt: "Konferenz- und Kongressräume",
		cineTxt: "Kinos",
		musTxt: "Museen und Ausstellungssäle",
		teaTxt: "Theater und Hörsäle",
		assCTxt: "Kulturvereine",
		istrTxt: "Bildung",
		scInTxt: "Kindergärten",
		scPrTxt: "Grundschulen",
		scSeTxt: "Mittelschulen",
		scSsTxt: "Oberschulen",
		cforTxt: "Ausbildungszentren",
		uniTxt: "Universität, Forschungszentren und Hochschulen",
		spoTxt: "Sport",
		indTxt: "In-Door Anlagen",
		pisTxt: "Schwimmbäder",
		outdTxt: "Out-Door Anlagen",
		giusTxt: "Justiz",
		medTxt: "Media",
		tvTxt: "Tv, Radio",
		giorTxt: "Zeitungen, Zeitschriften",
		onlTxt: "Online",
		finTxt: "Finanz- und Postdienstleistungen",
		banTxt: "Banken",
		uffPTxt: "Postämter",		
		chieseTxt: "Kirchen",
		filOrTxt: "Nach Uhrzeit und Datum filtern:",
		daTxt: "Von",
		aTxt: "Bis",
		orDaTxt: "Uhrzeit von",
		orATxt: "Uhrzeit bis",
		dataTxt: "Datum",
		filParChTxt: "Nach Schlüsselwort filtern:",
		chiaText: "Schlüsselw.",
		inPacText: "Schlüsselwort einfügen",
		filLuoTxt: "Nach Ort filtern:",
		quarTxt: "Viertel",
		aggiTxt: "Aktualisieren",
		tuttiTxt: "-ALLE-",
		donbTxt: "DON BOSCO",
		eurnoTxt: "EUROPA NEUSTIFT",
		ceprTxt: "ZENTRUM BOZ. BODEN",
		griTxt: "GRIES QUIREIN",
		oltrTxt: "OBERAU HASLACH"
	},
	...
	"gxp.plugins.HelpButton.prototype" :{
		...
		dontShowThisMessageAgainText: "Diese Meldung nicht wieder anzeigen"
	},
